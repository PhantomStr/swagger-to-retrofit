...
import static io.github.phantomstr.testing.tool.swagger2retrofit.App.main;
...
public class MavenGenerateGoal extends AbstractMojo {
    ...
    @Getter
    @Parameter(property = "io.github.phantomstr.testing.tool.swagger2retrofit.swagger2retrofit.commandline", required = true)
    private String commandline;

    @Getter
    @Parameter(property = "io.github.phantomstr.testing.tool.swagger2retrofit.swagger2retrofit.targetDir",
            defaultValue = "${project.build.sourceDirectory}")
    private String targetDir;

    @Getter
    @Parameter(property = "io.github.phantomstr.testing.tool.swagger2retrofit.swagger2retrofit.overrideFile",
