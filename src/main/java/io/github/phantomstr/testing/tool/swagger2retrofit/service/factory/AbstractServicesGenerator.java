package io.github.phantomstr.testing.tool.swagger2retrofit.service.factory;
...
import static io.github.phantomstr.testing.tool.swagger2retrofit.GlobalConfig.getOutputServiceDirectory;
...
public class AbstractServicesGenerator {
    ...
    private String createServicesFactory(List<ServiceClass> serviceClasses) {
        ...
        classSourceCode
                ...
                .append("import io.github.phantomstr.testing.tool.utils.rest.RestServiceProvider;").append(lineSeparator())
